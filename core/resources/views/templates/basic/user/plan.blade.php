                ...
                <div class="card">
                    <div class="card-body pt-5 pb-5 ">
                        <div class="pricing-table text-center mb-4">
                            <div class="bg-{{strtolower($data->name)}} p-3">
                            ...
                            <ul class="package-features-list mt-30">
                               <!-- <li class="">
                                ...
                                <li>
                                    <i class="fas fa-check bg--success"></i> <span> @lang('Referral Commission'): 10% </span>
                                    <span class="icon" data-toggle="modal" data-target="#refComInfoModal"><i
                                    class="fas fa-question-circle"></i></span>
                                </li>
                                <li>
                                    <i class="fas @if(getAmount($data->tree_com) != 0) fa-check bg--success @else fa-times bg--danger @endif "></i>  <span>@lang('Tree Commission'): 8% </span>
                        ...
                        <a href="#confBuyModal{{$data->id}}" data-toggle="modal" class="btn w-100 btn-outline--primary  mt-20 py-2 box--shadow1">@lang('Buy Now')</a>
