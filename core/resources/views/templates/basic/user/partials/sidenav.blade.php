            ...
            <ul class="sidebar__menu">
               ...
               <!-- <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('user.ptc*',3)}} my-2">
                        ...
                        <span class="menu-title">@lang('PTC')</span>
                    </a>
               ...
               <!-- <li class="sidebar-menu-item {{ menuActive('user.bv.log') }}">
                ...
                <li class="sidebar-menu-item {{ menuActive('user.my.tree') }}">
                 ...
                 <li class="sidebar-menu-item ">
                    <a href="{{env('APP_URL')}}/user/recognization" class="nav-link">
                        <i class="menu-icon las la-user"></i>
                        <span class="menu-title">Recognization</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('user.report*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('user.report.roi')}} ">
                                <a href="{{route('user.report.roi')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('ROI Log')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('user.report.level')}}">
                                <a href="{{route('user.report.level')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
