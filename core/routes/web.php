...
Route::get('/dev/clear/view', function(){
...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    Route::namespace('Auth')->group(function () {
        // Route::get('/', function(){
//            die("<h1>This site will be terminated soon! Contact developer for more details!</h1>");
  //      })->name('login');
        Route::get('/', 'LoginController@showLoginForm')->name('login-nh');
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('tran/test','TranController@test')->name('tran.test');
        Route::get('tran/roi','TranController@roi')->name('tran.roi');
...
Route::get('user/recognization', 'UserController@recognization')->middleware(['auth', 'checkStatus'])->name('user.rank.reward');
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::get('/add-user', 'UserController@showAddUser')->name('addUser');
            Route::get('/add-user/{username}/{position}', 'UserController@showAddUser')->name('addUserData');
            ...
            Route::get('report/roi/log', 'UserReportController@roiLog')->name('report.roi');
            Route::get('report/level/log', 'UserReportController@levelLog')->name('report.level');
            ...
            Route::get('/recognization', 'UserController@recognization')->name('user.recognization');
...
Route::get('/test/cron', "CronController@cron");