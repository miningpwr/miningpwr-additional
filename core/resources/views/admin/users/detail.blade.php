            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Balance')
                            <span class="font-weight-bold">{{getAmount($user->balance)}} {{$general->cur_sym}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Total LV')
                            <span class="font-weight-bold"><a href="{{route('admin.report.single.bvLog', $user->id)}}">{{getAmount($user->left_count)}} {{$general->cur_sym}}</a></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Total RV')
                            <span class="font-weight-bold"><a href="{{route('admin.report.single.bvLog', $user->id)}}">{{getAmount($user->right_count)}} {{$general->cur_sym}}</a></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                           @lang('Paid Left')
                            <span class="font-weight-bold">{{getAmount($user->left_count - $user->left_active)}} {{$general->cur_sym}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                           @lang('Paid Right')
                            <span class="font-weight-bold">{{getAmount($user->right_count - $user->right_active)}} {{$general->cur_sym}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Carry Left')
                            <span class="font-weight-bold">{{$user->left_active}} {{$general->cur_sym}} </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Carry Right')
                            <span class="font-weight-bold">{{$user->right_active}} {{$general->cur_sym}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Status')
                            @switch($user->status)
