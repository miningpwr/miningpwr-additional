        ...
        <div class="row justify-content-center mb-30-none">
            @foreach($plans  as $plan)
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                    <div class="plan-item">
                        <div class="plan-header text-center bg-{{strtolower($plan->name)}}">
                            <h3 class="title text-dark">{{__(@$plan->name)}}</h3>
                            <div class="plan-price">

                                <h3 class="price text-black"><span>{{$general->cur_sym}}</span>{{getAmount($plan->price)}}</h3>
                            </div>
                        </div>
                        <div class="plan-body text-center">
                            <ul class="plan-list">
                                ...
                                <li>
                                    ...
                                    <span class="icon" data-toggle="modal" data-target="#exampleModal3"><i
                                            class="fas fa-question-circle"></i></span>
                                </li>
                               <!-- <li>
