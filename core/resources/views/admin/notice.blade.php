                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea rows="10" class="form-control nicEdit"  name="free_user_notice" id="free-notice">{{ __($general->free_user_notice) }}</textarea>
                            </div>

                            <div class="form-group">
                                <label>@lang('All user notice')</label>
                                <textarea rows="10" class="form-control nicEdit"  name="notice" id="notice">{{ __($general->notice) }}</textarea>
                            </div>
