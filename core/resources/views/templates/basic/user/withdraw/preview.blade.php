        ...
        <div class="row justify-content-center mt-2">
            <div class="col-lg-8 ">
                <div class="card card-deposit">
                    <h5 class="text-center my-3">@lang($walletType) :
                        <strong>{{ getAmount($mainBalance) }}  {{ $general->cur_text }}</strong></h5>
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="form-group mt-5">
                                    ...
                                    <div class="input-group">
                                        <input type="text" value="{{getAmount($mainBalance - ($withdraw->amount))}}"  class="form-control form-control-lg" placeholder="@lang('Enter Amount')" required readonly>
